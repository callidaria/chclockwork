...
#define RENDERER_MAXIMUM_TEXTURE_COUNT 64
#define RENDERER_MAXIMUM_SPRITE_COUNT 1024
...
// shader
#define SHADER_MAXIMUM_DESCRIPTOR_SETS 16
#define SHADER_DESCRIPTOR_UNIFORM_COUNT 1024
#define SHADER_DESCRIPTOR_SAMPLER_COUNT 512
